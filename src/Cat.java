...
public class Cat {
	...
	private static final int HEAD_DIMENSION = 1000; //changed in fourth commit
	...
	private static final int MOUTH_X = HEAD_DIMENSION/5 * 1; //changed in sixth commit
	private static final int MOUTH_Y = HEAD_DIMENSION/5 * 1;//changed in sixth commit
